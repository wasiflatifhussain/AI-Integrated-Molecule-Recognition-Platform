...
class GCNPredictor(nn.Module):
    ...
    def __init__(self, in_feats, hidden_feats=None, gnn_norm=None, activation=None,
                 ...
                 hidden_feats2=None, activation2=None,
                 residual2=None, batchnorm2=None, dropout2=None,
        ...
        '''
        self.gnn2 = GCN(in_feats=in_feats,
                       hidden_feats=hidden_feats2,
                       gnn_norm=gnn_norm,
                       activation=activation2,
                       residual=residual2,
                       batchnorm=batchnorm2,
                       dropout=dropout2)
        '''

        gnn_out_feats = self.gnn.hidden_feats[-1]
        #gnn_out_feats = self.gnn.hidden_feats[-1] + self.gnn2.hidden_feats[-1]
        ...
        self.predict = nn.Sequential(
                ...
                nn.Linear(2*gnn_out_feats, predictor_hidden_feats),
                nn.ReLU(),
                nn.BatchNorm1d(predictor_hidden_feats),
    ...
    def forward(self, bg, feats):
        ...
        #node_feats = torch.cat([self.gnn(bg, feats), self.gnn2(bg, feats)],dim=1)
